...
#define LORA_REQUEST_WAIT_REPLY_TIME_MS 2500  //When received package is broadcasted, It takes time to receive the broadcasted data. This parameter indicating that time
