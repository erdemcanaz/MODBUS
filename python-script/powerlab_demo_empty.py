...
#import device driving libraries
...
machine_lab_inverter = Growatt_SPF5000ES(lora_address = 4 ,slave_address = 16,is_debugging=True , print_BESS_voltage = True, print_load_power= True, print_pv_power= True)
